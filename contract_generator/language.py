...
def format_date_ru(value: object) -> str:
    """Форматирует дату как «дд» месяц гггг г.

    Если значение не распознано как дата, возвращается исходный текст —
    молчаливая подмена юридически значимых данных недопустима.
    """
